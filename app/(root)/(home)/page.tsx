...
const HomePage = () => {
  return (
    <div>
      <div className="relative bg-[url('/bg-mobile.png')] md:bg-[url('/bg.png')] bg-cover bg-center h-[91dvh] flex items-center justify-center before:absolute before:top-0 before:left-0 before:w-full before:h-1/4 before:bg-gradient-to-b before:from-white before:to-transparent after:absolute after:bottom-0 after:left-0 after:w-full after:h-1/4 after:bg-gradient-to-t after:from-white after:to-transparent">
